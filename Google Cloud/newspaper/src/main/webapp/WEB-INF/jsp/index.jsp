                    ...
                    <c:forEach var="post" items="${posts}">
                        ...
                        <div class="single-blog-post featured-post mb-30">
                            <div class="post-thumb">
                                <a href="#"><img src="static/img/newspaper-img/thumbnail/${post.id}.jpg" alt=""></a>
                            </div>
                            <div class="post-data">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <!-- Copywrite -->
                        <p>
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved. Powered by Colorlib</a>
